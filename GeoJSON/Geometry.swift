...
open class Geometry: NSObject {
     ...
     */
    open var dictionaryRepresentation: [String:AnyObject] {
            ...
            if let geos = geometries {
                ...
                if type == .Circle {
                    ...
                    if let firstCoord = coords.first {
                        dict["coordinates"] = firstCoord.dictionaryRepresentation as AnyObject
                    }
                ...
                dict["coordinates"] = outerCoords as AnyObject
                ...
                dict["coordinates"] = outerArray as AnyObject
     ...
     */
    fileprivate func processShapes(_ dictionary: [String:AnyObject]) {
...
public func +(left: Geometry, right: Position) -> Geometry {
    ...
    dictionaryRepresentation["type"] = typeString as AnyObject
